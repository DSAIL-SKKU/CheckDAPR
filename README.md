...
python CheckDAPR.py
```
This code uses the pre-trained object detection model YOLO-v8 and it employs GPT-4v as the MLLM. 

In the API key section of this code(line 9), enter your own API key.
```
# API Key
